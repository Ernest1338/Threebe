# This is an file containing different functions that extracts information
# from a executable file.
...
def bin_get_info(bytes, colorsFromFunction):
    ...
    if fileformat == "ELF":
        if endian == "Little":
            entrypoint = "0x" + bytes[27][1] + \
                bytes[26] + bytes[25] + bytes[24]
        elif endian == "Big":
            entrypoint = "0x" + bytes[24][1] + \

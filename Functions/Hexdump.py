# This is an file containing different functions that parses binary data
...
def hexdump_parser_32(hexdump, bytes, address1, colors):
    ...
    for i in parsed2:
        if len(parsed3) < 96:
            ...
            for a in parsed3.split(" "):
                try:
                    if chr(int(a, 16)).isprintable():
                        ascii1 += f"{bcolors.WARNING}" + \
                            chr(int(a, 16)) + f"{bcolors.RESET}"
                        parsed4 += f"{bcolors.WARNING}" + \
                            str(a) + f"{bcolors.RESET}" + " "
                        parsed5.append(True)
                    else:
                        ascii1 += "."
                        parsed4 += str(a) + " "
            ...
            for b in range(len(parsed6)):
                try:
                    if parsed5[b]:
                        parsed6[b] = f"{bcolors.WARNING}" + str(
                            parsed3.split(" ")[b].upper()) + f"{bcolors.RESET}" + " "
                    else:
            ...
            print(
                ...
                f"{bcolors.RESET}  " +
                parsed7 +
                f"{bcolors.OKBLUE}| {bcolors.RESET}" +
                ascii1)  # len - 51
    ...
    try:
        ...
        for b in range(len(parsed6)):
            try:
                if parsed5[b]:
                    parsed6[b] = f"{bcolors.WARNING}" + \
                        str(parsed3.split(" ")[b].upper()) + f"{bcolors.RESET}" + " "
                else:
                    parsed6[b] = str(parsed3.split(" ")[b].upper()) + " "
            except BaseException:
                parsed6[b] = str(parsed3.split(" ")[b].upper()) + " "
    ...
    print(f"{bcolors.OKBLUE}" + offset2 + f"{bcolors.RESET}  " +
          parsed7 + f"{bcolors.OKBLUE}| {bcolors.RESET}" + ascii1)

...
def main():
    ...
    if len(sys.argv)==1:
        ...
        print(f"{hexdump.bcolors.HEADER}Threebe {hexdump.bcolors.OKBLUE}- Tool for displaying a Hexdump / Disassembly / Strings / Information from/of a (binary) file.")
        print("")
        print("Usage:")
        print(f"{hexdump.bcolors.OKGREEN}./Threebe.py <parameter(s)> <file>")
        print(f"{hexdump.bcolors.OKBLUE}")
        print(f"{hexdump.bcolors.HEADER}Possible parameters:")
        print(f"{hexdump.bcolors.OKBLUE}")
        print("===== HEXDUMP =====")
        print(f"{hexdump.bcolors.OKGREEN}")
        ...
        print("")
        print(f"{hexdump.bcolors.OKBLUE}===== DISASSEMBLY =====")
        print(f"{hexdump.bcolors.OKGREEN}")
        print("-dx86  - Display the disassembly of a given x86 binary file.")
        print("")
        print(f"{hexdump.bcolors.OKBLUE}===== INFORMATION =====")
        print(f"{hexdump.bcolors.OKGREEN}")
        print("-i     - Display informations about a given binary file.")
        print("")
        print(f"{hexdump.bcolors.OKBLUE}===== STRINGS =====")
        print(f"{hexdump.bcolors.OKGREEN}")
